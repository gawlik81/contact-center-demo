...
**Ostatnia aktualizacja:** 2026-06-20 (EPIC-25 zakończony ✅; EPIC-26 zakończony ✅; EPIC-28 w trakcie 🔄 — warstwa DB zamknięta (DB-042..DB-045 zrobione, 43/43), BE-097 (plugin-sdk), BE-098 (Plugin/PluginVersion + walidacja) i BE-099 (PluginUploadController + object storage) zrobione ✅, patrz `EPIC-28-PLAN.md`; następny w kolejce BE-100 (TenantPluginInstallation + PluginRegistrationService); łączny stan: DB 43/43, BE 95/103, FE 75/79)
