...
**How to apply:** Przy kolejnych zadaniach DB zakładaj że V001-V084 już istnieją (ostatnia: V084__create_retention_purge_log.sql, 2026-08-09). Numery migracji kontynuuj od V085+. Zawsze zweryfikuj `ls backend/src/main/resources/db/migration/` przed napisaniem nowej migracji — nie ufaj tej liczbie bezkrytycznie.
