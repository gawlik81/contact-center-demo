...
**Ostatnia aktualizacja:** 2026-06-20 (EPIC-25 zakończony ✅; EPIC-26 zakończony ✅; EPIC-28 w trakcie 🔄 — warstwa DB zamknięta (DB-042..DB-045 zrobione, 43/43), BE-097 (plugin-sdk), BE-098 (Plugin/PluginVersion + walidacja), BE-099 (PluginUploadController + object storage) i BE-100 (TenantPluginInstallation + PluginRegistrationService) zrobione ✅, patrz `EPIC-28-PLAN.md`; następny w kolejce BE-101 (PluginRuntimeManager, XL); łączny stan: DB 43/43, BE 96/103, FE 75/79)
