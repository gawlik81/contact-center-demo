...
- [contact_center_project.md](project_contact_center.md) – Stack, decyzje architektoniczne, lokalizacja migracji Flyway, stan po V085 (partycjonowanie contact_event, EPIC-29, PIERWSZY online-swap istniejącej tabeli z danymi w repo, wzorzec temp-suffix dla PK/indeksów vs finalna nazwa od razu dla CHECK/trigger/policy), metoda weryfikacji Flyway z hosta przez bridge IP, brak infrastruktury Testcontainers dla testów migracji
