...
- [contact_center_project.md](project_contact_center.md) – Stack, decyzje architektoniczne, lokalizacja migracji Flyway, stan po V086 (partycjonowanie contact_event/V085 i contact_transcription/V086, EPIC-29, wzorzec online-swap: temp-suffix dla PK/indeksów vs finalna nazwa od razu dla CHECK/trigger/policy; zachowaj oryginalny styl nazwy PK — auto `..._pkey` vs jawne `pk_...`), metoda weryfikacji Flyway z hosta przez bridge IP, brak infrastruktury Testcontainers dla testów migracji
