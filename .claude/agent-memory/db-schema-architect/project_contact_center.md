...
**How to apply:** Przy kolejnych zadaniach DB zakładaj że V001-V088 już istnieją (ostatnia: V088__fix_partition_rotation_functions.sql, 2026-08-09 — DB-052, FUNDAMENT epiku EPIC-29, zaaplikowana bezpośrednio po V087/DB-051 tego samego dnia). Numery migracji kontynuuj od najwyższego istniejącego +1. Zawsze zweryfikuj `ls backend/src/main/resources/db/migration/` przed napisaniem nowej migracji — nie ufaj tej liczbie bezkrytycznie.
