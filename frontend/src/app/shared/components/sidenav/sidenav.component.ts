...
const SUPERVISOR_NAV: NavItem[] = [
  ...
  {
    label: 'nav.agentGroups',
    route: '/supervisor/agent-groups',
    ariaLabel: 'nav.agentGroups',
    svgPath:
  ...
  },
  {
    ...
    ariaLabel: 'nav.reports',
    svgPath: 'M3.5 18.49l6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L2 16.99z',
    children: [
      {
        label: 'nav.reportsHistorical',
        route: '/supervisor/reports',
        ariaLabel: 'nav.reportsHistorical',
        svgPath:
      ...
      {
        label: 'nav.reportsContacts',
        route: '/supervisor/reports/contacts',
        ariaLabel: 'nav.reportsContacts',
        svgPath:
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        ariaLabel: 'nav.settingsPhoneNumbers',
        svgPath:
          'M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z',
      },
      {
        label: 'nav.settingsSocialMedia',
      ...
      },
      {
        ...
        route: '/supervisor/settings/email-templates',
        ariaLabel: 'nav.settingsEmailTemplates',
        svgPath:
          'M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z',
      },
      {
        label: 'nav.settingsTwilioConfig',
        route: '/supervisor/settings/twilio',
      ...
      },
      {
        ...
        route: '/supervisor/settings/plugins',
      ...
      {
        label: 'nav.settingsDataRetention',
        route: '/supervisor/settings/data-retention',
        ariaLabel: 'nav.settingsDataRetention',
        svgPath:
          'M6 7h12v12c0 1.1-.9 2-2 2H8c-1.1 0-2-.9-2-2V7zm10-3V3c0-.55-.45-1-1-1H9c-.55 0-1 .45-1 1v1H4v2h16V4h-4zM9 4h6v1H9V4zm-.5 6H10v7H8.5v-7zm3.75 0h1.5v7h-1.5v-7zm3.75 0h1.5v7H16v-7z',
        roles: ['ADMIN'],
      },
    ],
  },
