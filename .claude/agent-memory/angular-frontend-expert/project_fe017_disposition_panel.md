...
**Nowe pliki:**
- `features/agent/services/contact.service.ts` – ContactService, metoda `setDisposition(contactId, code, notes): Observable<ContactResponse>` → PATCH `/api/contacts/{id}/disposition`
