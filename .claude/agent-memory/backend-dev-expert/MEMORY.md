...
- [BE-099/BE-100 DTO enrichment dla FE-097](project_be099_be100_dto_enrichment_fe097.md) — PluginVersionDto+displayName/vendor; TenantPluginInstallationDto+pluginKey/displayName/version/manualActions/uiPanels; bug: manifestToMap nie zapisywał uiPanels/manualActions do manifestJson; mapToDto dociąga PluginVersion+Plugin, batch findAllById w listInstallations
