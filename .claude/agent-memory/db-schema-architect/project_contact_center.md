...
**How to apply:** Przy kolejnych zadaniach DB zakładaj że V001-V082 już istnieją (ostatnia: V082__create_tenant_retention_policy.sql, 2026-08-09). Numery migracji kontynuuj od V083+. Zawsze zweryfikuj `ls backend/src/main/resources/db/migration/` przed napisaniem nowej migracji — nie ufaj tej liczbie bezkrytycznie.
