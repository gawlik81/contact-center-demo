...
**Ostatnia aktualizacja:** 2026-06-20 (EPIC-25 zakończony ✅; EPIC-26 zakończony ✅; EPIC-28 w trakcie 🔄 — warstwa DB zamknięta (DB-042..DB-045 zrobione, 43/43), BE-097 (plugin-sdk) i BE-098 (Plugin/PluginVersion + walidacja) zrobione ✅, patrz `EPIC-28-PLAN.md`; następny w kolejce BE-099 (zapis JAR-a do object storage + plugin_version); łączny stan: DB 43/43, BE 94/103, FE 75/79)
