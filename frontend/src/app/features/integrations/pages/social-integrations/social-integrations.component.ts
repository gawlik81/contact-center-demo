...
const PLATFORM_CARDS: PlatformCard[] = [
  {
    platform: 'FACEBOOK',
    label: 'Facebook',
    description: 'Połącz stronę Facebook, aby odbierać wiadomości Messenger.',
    svgPath:
  ...
  },
  {
    platform: 'INSTAGRAM',
    label: 'Instagram',
    description: 'Połącz konto Instagram Business, aby odbierać wiadomości Direct.',
    svgPath:
  ...
  },
  {
    platform: 'WHATSAPP',
    label: 'WhatsApp',
    description: 'Integracja WhatsApp Business API przez Meta Business Suite.',
    svgPath:
...
@Component({
  ...
  styleUrl: './social-integrations.component.scss',
})
export class SocialIntegrationsComponent implements OnInit {
  ...
  readonly connectingPlatform = signal<SocialPlatform | null>(null);
  ...
  openDisconnectDialog(integration: SocialIntegration): void {
    this.pendingDisconnect.set(integration);
  ...
  confirmDisconnect(): void {
    const integration = this.pendingDisconnect();
